...
import com.simpli.workshopmongo.dto.AuthorDTO;
import com.simpli.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/05/2021"), "Bom dia", "Acordei feliz hoje", new AuthorDTO(maria));
